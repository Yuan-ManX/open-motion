...
import { listTemplates, getTemplate, searchTemplatesByQuery } from "../../db/repositories/templates.js";
...
export function searchTemplates(query: string, limit?: number) {
  return searchTemplatesByQuery(query, limit);
}
